<nav class="navbar navbar-vertical navbar-expand-lg" >
    ...
    <li class="nav-item">
      <!-- label-->
      <p class="navbar-vertical-label">Stocks</p>
      <hr class="navbar-vertical-line" />
      <!-- parent pages-->
      <span class="nav-item-wrapper">
        <a class="nav-link label-1" href="{{ route('category.index') }}" role="button" data-bs-toggle="" aria-expanded="false">
            <div class="d-flex align-items-center">
                <span class="nav-link-icon font-awesome"><span class="fa-solid fa-list fs-0 ms-1"></span></span>
        ...
        <span class="nav-item-wrapper">
          <a class="nav-link label-1" href="{{ route('brand.index') }}" role="button" data-bs-toggle="" aria-expanded="false">
              <div class="d-flex align-items-center">
                  <span class="nav-link-icon font-awesome"><span class="fa-solid fa-copyright fs-0 ms-1"></span></span>
                  <span class="nav-link-text-wrapper"><span class="nav-link-text">Brand</span></span>
              </div>
          </a>
          </span>
        <span class="nav-item-wrapper">
          <a class="nav-link label-1" href="{{ route('boxOption.index') }}" role="button" data-bs-toggle="" aria-expanded="false">
              <div class="d-flex align-items-center">
                  <span class="nav-link-icon font-awesome"><span class="fa-solid fa-box fs-0 ms-1"></span></span>
                  <span class="nav-link-text-wrapper"><span class="nav-link-text">Box Option</span></span>
              </div>
          </a>
          </span>

          <span class="nav-item-wrapper">
            <a class="nav-link label-1" href="{{ route('products.index') }}" role="button" data-bs-toggle="" aria-expanded="false">
                <div class="d-flex align-items-center">
                    <span class="nav-link-icon font-awesome"><span class="fa-brands fa-product-hunt fs-0 ms-1"></span></span>
    ...
    <li class="nav-item">
      ...
      <!-- parent pages-->
      <span class="nav-item-wrapper">
        <a class="nav-link label-1" href="{{ route('role.index') }}" role="button" data-bs-toggle="" aria-expanded="false">
            <div class="d-flex align-items-center">
                <span class="nav-link-icon font-awesome"><span class="fa-solid fa-list fs-0 ms-1"></span></span>
                <span class="nav-link-text-wrapper"><span class="nav-link-text">Category</span></span>
            </div>
    ...
    <li class="nav-item">
      <!-- label-->
      <p class="navbar-vertical-label">Payment</p>
      <hr class="navbar-vertical-line" />
      <!-- parent pages-->
      <span class="nav-item-wrapper">
        <a class="nav-link label-1" href="{{ route('role.index') }}" role="button" data-bs-toggle="" aria-expanded="false">
    ...
    <li class="nav-item">
      <!-- label-->
      <p class="navbar-vertical-label">Manual buying process</p>
      <hr class="navbar-vertical-line" />
      <!-- parent pages-->
      <span class="nav-item-wrapper">
        <a class="nav-link label-1" href="{{ route('manual.cashier.index') }}" role="button" data-bs-toggle="" aria-expanded="false">
            <div class="d-flex align-items-center">
                <span class="nav-link-icon font-awesome"><span class="fa-solid fa-cash-register fs-0 ms-1"></span></span>
                <span class="nav-link-text-wrapper"><span class="nav-link-text">Cashier</span></span>
            </div>
        </a>
        </span>

        <span class="nav-item-wrapper">
          <a class="nav-link label-1" href="{{ route('sale.history') }}" role="button" data-bs-toggle="" aria-expanded="false">
              <div class="d-flex align-items-center">
                  <span class="nav-link-icon font-awesome"><span class="fa-solid fa-copyright fs-0 ms-1"></span></span>
                  <span class="nav-link-text-wrapper"><span class="nav-link-text">Sale History</span></span>
              </div>
          </a>
          </span>
...
<li class="nav-item">
  ...
  <span class="nav-item-wrapper">
    <a class="nav-link label-1" href="{{ route('role.index') }}" role="button" data-bs-toggle="" aria-expanded="false">
        <div class="d-flex align-items-center">
            <span class="nav-link-icon font-awesome"><span class="fa-solid fa-list-check fs-0 ms-1"></span></span>
            <span class="nav-link-text-wrapper"><span class="nav-link-text">Roles</span></span>
        </div>
    </a>
    </span>

  <span class="nav-item-wrapper">
    <a class="nav-link label-1" href="{{ route('users.get') }}" role="button" data-bs-toggle="" aria-expanded="false">
        <div class="d-flex align-items-center">
            <span class="nav-link-icon font-awesome"><span class="fas fa-users fs-0 ms-1"></span></span>
            <span class="nav-link-text-wrapper"><span class="nav-link-text">Users</span></span>
        </div>
    </a>
  </span>
      ...
      <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border border-300" aria-labelledby="navbarDropdownUser">
        <div class="card position-relative border-0">
          ...
          <div class="card-footer p-0 border-top">
            ...
            <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="#!"> <span class="me-2" data-feather="log-out"> </span>
